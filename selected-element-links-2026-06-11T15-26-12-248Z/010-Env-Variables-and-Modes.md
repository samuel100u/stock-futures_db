...
Exported: 2026-06-11T15:26:03.197Z
Language: en-US
...
### NODE\_ENV and Modes [​](https://vite.dev/guide/env-and-mode#node-env-and-modes)
...
| NODE\_ENV=development vite build | "development" | "production" |
| NODE\_ENV=development vite build --mode development | "development" | "development" |

The different values of `NODE_ENV` and mode also reflect on its corresponding `import.meta.env` properties:

| Command | import.meta.env.PROD | import.meta.env.DEV |
| --- | --- | --- |
| NODE\_ENV=production | true | false |
| NODE\_ENV=development | false | true |
| NODE\_ENV=other | false | true |
