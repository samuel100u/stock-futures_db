...
Exported: 2026-06-11T15:26:03.820Z
Language: en-US
...
## Example Projects [​](https://vite.dev/guide/ssr#example-projects)
...
## Source Structure [​](https://vite.dev/guide/ssr#source-structure)
...
## Conditional Logic [​](https://vite.dev/guide/ssr#conditional-logic)
...
## Setting Up the Dev Server [​](https://vite.dev/guide/ssr#setting-up-the-dev-server)
...
## Building for Production [​](https://vite.dev/guide/ssr#building-for-production)
...
Refer to the [example projects](https://vite.dev/guide/ssr#example-projects) for a working setup.

## Generating Preload Directives [​](https://vite.dev/guide/ssr#generating-preload-directives)
...
## Pre-Rendering / SSG [​](https://vite.dev/guide/ssr#pre-rendering-ssg)
...
## SSR Externals [​](https://vite.dev/guide/ssr#ssr-externals)
...
## SSR-specific Plugin Logic [​](https://vite.dev/guide/ssr#ssr-specific-plugin-logic)
...
## SSR Target [​](https://vite.dev/guide/ssr#ssr-target)
...
## SSR Bundle [​](https://vite.dev/guide/ssr#ssr-bundle)
...
## SSR Resolve Conditions [​](https://vite.dev/guide/ssr#ssr-resolve-conditions)
...
## Vite CLI [​](https://vite.dev/guide/ssr#vite-cli)
